...
const feedTopFade = { position:"absolute", top:0, left:0, right:0, height:"160px", background:"linear-gradient(to bottom, var(--bg) 0%, var(--bg) 18%, transparent 100%)", pointerEvents:"none", zIndex:2 };
