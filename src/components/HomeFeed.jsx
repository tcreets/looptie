...
const articleFallbackContent = { position:"absolute", inset:0, display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", gap:"10px", borderRadius:"inherit", overflow:"hidden", background:"linear-gradient(145deg, color-mix(in srgb, var(--surface) 72%, #f3e8ff 28%), color-mix(in srgb, var(--surface) 72%, #ddd6fe 28%))" };
const articleFallbackIllustration = { position:"absolute", right:"-24px", bottom:"-30px", width:"190px", height:"150px", opacity:.62, transform:"rotate(-8deg)", pointerEvents:"none" };
const articleFallbackPaperBack = { position:"absolute", width:"120px", height:"100px", right:"34px", bottom:"4px", borderRadius:"24px", background:"rgba(139,92,246,.18)", transform:"rotate(-10deg)" };
const articleFallbackPaper = { position:"absolute", width:"118px", height:"104px", right:"0", bottom:"18px", borderRadius:"24px", background:"rgba(139,92,246,.30)", display:"flex", flexDirection:"column", gap:"10px", padding:"28px 22px", boxSizing:"border-box" };
