...
const articleFallbackContent = { position:"absolute", inset:0, display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", gap:"10px", borderRadius:"inherit", overflow:"hidden", background:"radial-gradient(circle at -7% 108%, rgba(139,92,246,.58) 0 18%, transparent 18.3%), radial-gradient(circle at 104% -8%, rgba(139,92,246,.32) 0 24%, transparent 24.3%), radial-gradient(ellipse 70% 58% at 5% 100%, rgba(124,58,237,.30) 0%, rgba(109,40,217,.12) 48%, transparent 72%), radial-gradient(ellipse 78% 60% at 100% 0%, rgba(139,92,246,.22) 0%, rgba(91,33,182,.10) 50%, transparent 75%), linear-gradient(145deg, color-mix(in srgb, var(--surface-elevated) 86%, #6d28d9 14%), var(--surface))" };
