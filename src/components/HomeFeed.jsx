...
const articleFallbackContent = { position:"absolute", inset:0, display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", gap:"10px", borderRadius:"inherit", overflow:"hidden", background:"linear-gradient(145deg, var(--article-fallback-start), var(--article-fallback-end))" };
