...
const articleFallbackContent = { position:"absolute", inset:0, display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", gap:"10px", borderRadius:"inherit", overflow:"hidden", background:"radial-gradient(circle at -7% 108%, color-mix(in srgb, #8b5cf6 52%, transparent) 0%, color-mix(in srgb, #8b5cf6 42%, transparent) 13%, color-mix(in srgb, #8b5cf6 20%, transparent) 22%, transparent 34%), radial-gradient(circle at 104% -8%, color-mix(in srgb, #8b5cf6 34%, transparent) 0%, color-mix(in srgb, #8b5cf6 26%, transparent) 17%, color-mix(in srgb, #8b5cf6 11%, transparent) 27%, transparent 39%), radial-gradient(ellipse 70% 58% at 5% 100%, color-mix(in srgb, #7c3aed 30%, transparent) 0%, color-mix(in srgb, #6d28d9 12%, transparent) 48%, transparent 72%), linear-gradient(145deg, color-mix(in srgb, var(--surface) 68%, #ede9fe 32%), color-mix(in srgb, var(--surface) 90%, #8b5cf6 10%))" };
