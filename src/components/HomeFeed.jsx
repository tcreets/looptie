...
const articleFallbackContent = { position:"absolute", inset:0, display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", gap:"10px", borderRadius:"inherit", overflow:"hidden", background:"linear-gradient(145deg, color-mix(in srgb, var(--surface) 94%, #f5f0ff 6%), color-mix(in srgb, var(--surface-elevated) 90%, #ede9fe 10%))" };
