...
const articleFallbackContent = { position:"absolute", inset:0, display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", gap:"10px", borderRadius:"inherit", overflow:"hidden", background:"radial-gradient(ellipse 70% 58% at 5% 100%, rgba(124,58,237,.42) 0%, rgba(109,40,217,.18) 45%, transparent 72%), radial-gradient(ellipse 78% 60% at 100% 0%, rgba(139,92,246,.32) 0%, rgba(91,33,182,.15) 48%, transparent 75%), linear-gradient(145deg, color-mix(in srgb, var(--surface-elevated) 82%, #6d28d9 18%), var(--surface))" };
