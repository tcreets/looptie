...
const articleFallbackContent = { position:"absolute", inset:0, display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", gap:"10px", borderRadius:"inherit", overflow:"hidden", background:"radial-gradient(circle at -7% 108%, rgba(139,92,246,.68) 0%, rgba(139,92,246,.50) 13%, rgba(139,92,246,.24) 23%, transparent 35%), radial-gradient(circle at 104% -8%, rgba(167,139,250,.55) 0%, rgba(139,92,246,.38) 18%, rgba(139,92,246,.16) 29%, transparent 41%), radial-gradient(ellipse 72% 62% at 50% 48%, rgba(124,58,237,.12) 0%, transparent 70%), linear-gradient(145deg, color-mix(in srgb, var(--surface) 58%, #8b5cf6 42%), color-mix(in srgb, var(--surface) 74%, #6d28d9 26%))" };
