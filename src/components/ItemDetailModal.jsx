...
const articleWebFallback = { flex:1, minHeight:0, display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", padding:"28px 20px", boxSizing:"border-box", background:"var(--surface)" };
const articleWebFallbackImage = { width:"min(520px, 100%)", maxHeight:"300px", objectFit:"cover", borderRadius:"18px", marginBottom:"22px" };
const articleWebFallbackContent = { width:"min(520px, 100%)", textAlign:"center" };
const articleWebFallbackSource = { color:"var(--brand)", fontSize:"var(--text-xs)", fontWeight:"var(--weight-semibold)", marginBottom:"8px" };
const articleWebFallbackTitle = { color:"var(--text-primary)", fontSize:"clamp(22px, 4vw, 30px)", lineHeight:1.15, margin:"0 0 8px" };
const articleWebFallbackCreator = { color:"var(--text-secondary)", fontSize:"var(--text-sm)", marginBottom:"20px" };
const articleWebFallbackButton = { display:"inline-flex", alignItems:"center", justifyContent:"center", gap:"6px", minHeight:"42px", padding:"0 18px", borderRadius:"999px", background:"var(--brand)", color:"white", textDecoration:"none", fontSize:"var(--text-sm)", fontWeight:"var(--weight-semibold)" };
const articleWebFallbackHint = { marginTop:"10px", color:"var(--text-muted)", fontSize:"var(--text-xs)" };
