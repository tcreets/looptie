...
const uploadTitle = { color: "var(--text-primary)", fontWeight: "500", fontSize: "18px", marginBottom: "20px" };
const chooseMediaButton = { marginTop: "18px", padding: "12px 16px", borderRadius: "14px", background: "var(--surface-elevated)", color: "var(--text-primary)", textAlign: "center", fontWeight: "600" };
const selectedCount = { marginTop: "14px", color: "var(--text-secondary)", fontSize: "14px" };
const modalInput = { width: "100%", boxSizing: "border-box", padding: "16px", borderRadius: "16px", border: "1px solid var(--border)", background: "var(--surface)", color: "var(--text-primary)", fontSize: "16px", marginTop: "16px", marginBottom: "16px" };
...
const selectChevron = { position: "absolute", right: "16px", top: "50%", transform: "translateY(-50%)", pointerEvents: "none", color: "var(--text-secondary)", fontSize: "14px" };
...
const spaceCancelButton = { width: "100%", marginTop: "12px", padding: "14px", borderRadius: "16px", border: "1px solid var(--border)", background: "transparent", color: "var(--text-primary)", fontWeight: "bold", cursor: "pointer" };
...
const successCard = { background: "var(--surface)", border: "1px solid var(--border)", borderRadius: "20px", padding: "24px 32px", color: "var(--text-primary)", fontSize: "18px", fontWeight: "600", display: "flex", alignItems: "center", justifyContent: "center", gap: "10px", boxShadow: "var(--shadow)" };
...
const uploadLimitText = { color: "var(--text-muted)", fontSize: "13px", textAlign: "center", marginTop: "8px" };
