...
const label={display:"block",marginBottom:"8px",color:"var(--text-secondary)",fontSize:"14px"};
const input={width:"100%",boxSizing:"border-box",padding:"16px",borderRadius:"16px",border:"1px solid var(--border)",background:"var(--surface)",color:"var(--text-primary)",fontSize:"16px",marginBottom:"16px"};
...
const themeButton={padding:"11px 8px",borderRadius:"12px",border:"1px solid transparent",background:"transparent",color:"var(--text-secondary)",fontWeight:"600",cursor:"pointer"};
...
const appearanceHint={color:"var(--text-muted)",fontSize:"13px",margin:"8px 0 20px"};
const saveButton={width:"100%",padding:"14px",borderRadius:"16px",border:"none",background:"var(--brand)",color:"white",fontWeight:"bold",cursor:"pointer",marginTop:"8px"};
const logoutButton={width:"100%",padding:"14px",borderRadius:"16px",border:"1px solid var(--border)",background:"var(--surface)",color:"var(--text-primary)",fontWeight:"bold",cursor:"pointer",marginTop:"28px"};
const deleteButton={width:"100%",padding:"14px",borderRadius:"16px",border:"1px solid var(--danger)",background:"transparent",color:"var(--danger)",fontWeight:"bold",cursor:"pointer",marginTop:"14px"};