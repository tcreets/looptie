...
export default function SettingsScreen({ profile, spaces, defaultFeed, setDefaultFeed, setActiveFeed, setProfile, setTab, user, deleteAllUserItemsAndStorage }) {
  ...
  const handleDeleteAccount = async () => {
    const confirmDelete = window.confirm("Are you sure? This will permanently delete your account and all Looptie data.");
  ...
  return <div style={page}>
    ...
    <label style={label}>Email</label><input style={{ ...input, opacity: 0.7, cursor: "not-allowed" }} value={profile?.email || ""} disabled />
