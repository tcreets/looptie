...
const title = { fontSize: "34px", lineHeight: "1.05", marginBottom: "18px", color: "var(--text-primary)", fontWeight: "700" };
const body = { fontSize: "17px", lineHeight: "1.5", color: "var(--text-primary)", marginBottom: "18px" };
const subtext = { fontSize: "15px", lineHeight: "1.5", color: "var(--text-secondary)", marginBottom: "32px" };
const list = { display: "flex", flexDirection: "column", gap: "14px", marginBottom: "24px" };
const listItem = { display: "flex", gap: "10px", fontSize: "16px", color: "var(--text-primary)" };
const bullet = { color: "var(--brand)" };
const input = { width: "100%", padding: "14px 16px", borderRadius: "16px", border: "1px solid var(--border)", background: "var(--surface-elevated)", color: "var(--text-primary)", fontSize: "16px", outline: "none", marginBottom: "16px", boxSizing: "border-box" };
const button = { width: "100%", padding: "15px 18px", borderRadius: "999px", border: "none", background: "var(--brand)", color: "white", fontSize: "16px", fontWeight: "700", cursor: "pointer", marginTop: "8px" };