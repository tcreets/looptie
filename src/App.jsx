  ...
  return (
    <div style={appStyle}>
      <div style={contentStyle}>
        {tab === "home" && <HomeFeed spaces={spaces} activeFeed={currentFeed} setActiveFeed={setActiveFeed} feedRef={feedRef} filteredFeedItems={filteredFeedItems} setSelectedItem={openItemModal} onAddContent={() => { setUploadSpace(currentFeed); setTab("add"); }} />}
        ...
        {tab === "profile" && <Profile items={feedItems} spaces={spaces} setSelectedItem={openItemModal} setTab={setTab} profile={profile} activities={activities} hasUnreadActivity={hasUnreadActivity} markAllRead={markAllRead} onOpenActivityFeed={(feed) => { setSelectedSpace(feed.name); setTab("spaces"); }} />}
